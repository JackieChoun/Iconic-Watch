...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="mx-4 my-4 flex items-center justify-between">
            ...
            <div>
                <input v-model="form.tmdb_id" type="number" placeholder="ID TMDB" class="rounded border px-4 py-1" required />
                <button class="m-4 cursor-pointer rounded bg-blue-800 px-4 py-2 font-bold text-white hover:bg-blue-900" @click.prevent="submitForm">
                    Ajouter un film
                </button>
            </div>
        </div>
